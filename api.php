...
if(strpos($result3, '"seller_message": "Payment complete."' )) {
    echo '#CHARGED</span>  </span>CC:  '.$lista.'</span>  <br>➤ Response: $1 Charged ✅ @About_DeadShot<br> ➤ Receipt : <a href='.$receipturl.'>Here</a><br>';
}
...
elseif(strpos($result2,'"code": "incorrect_cvc"')){
    echo '#LIVE</span>  </span>CC:  '.$lista.'</span>  <br>Result: Security code is incorrect by @About_DeadShot</span><br>';
}
...
elseif(strpos($result3, "lost_card" )) {
    echo '#DIE</span>  </span>CC:  '.$lista.'</span>  <br>Result: LOST CARD</span></span>  <br>Result: CHECKER BY DEADSHOT</span> <br>';
}
...
elseif(strpos($result2,'"cvc_check": "unchecked"')){
    echo '#DIE</span>  </span>CC:  '.$lista.'</span>  <br>Result: GENERIC DECLINE @OFFICIALBINS</span><br>';
}
...
elseif(strpos($result1, "card_not_supported" )) {
    ...
    echo '#DIE</span> CC:  '.$lista.'</span>  <br>Result: GENERIC DECLINE @OFFICIALBINS</span><br>';
