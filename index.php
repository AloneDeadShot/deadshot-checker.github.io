...
<html class="loading">
  <head>
    ...
    <title>DEADSHOT CHECKER </title>
    <link href="https://fonts.
    
    googleapis.com/css?family=Muli:300,300i,400,400i,600,600i,700,700i%7CComfortaa:300,400,700" rel="stylesheet">
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>DEADSHOT CHECKER</strong></h4>
...
Swal.fire({ title: "@About_DeadShot", text: "Join Our Telegram Channel :(", icon: "warning", confirmButtonText: "OK", buttonsStyling: false, confirmButtonClass: 'btn btn-primary'});
